...
{% materialization incremental, adapter='snowflake' -%}
  ...
  {% if old_relation is not none and not full_refresh_mode and adapter.target_contains_schema_change(old_relation=existing_relation, to_relation=target_relation) %}
